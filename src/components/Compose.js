...
const Compose = (props) => {
  ...
  const saveData = () => {
    ...
    const senturl = ` https://mailboxclient-24879-default-rtdb.firebaseio.com/${sentByRegex}/sent.json`;
    const receivedurl = ` https://mailboxclient-24879-default-rtdb.firebaseio.com/${toRefRgx}/received.json`;
